...
func TestCleanupPrint(t *testing.T) {
	...
	fmt.Println("Key pair deleted                               vault-EC2-AD-kp")
	fmt.Println("AWS role detatched from custom role            AmazonSSMAutomationRole")
	fmt.Println("Custom role detached from instance profile     ec2-admin-role-vaultAD")
	fmt.Println("Instance profile deleted                       ec2-InstProf-vaultAD")
	fmt.Println("Custom role deleted                            ec2-admin-role-vaultAD")
